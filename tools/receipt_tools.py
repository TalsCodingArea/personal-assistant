...
def _extract_with_openai(
    ...
    if not content_probe["has_selectable_text"] or parsed.get("confidence", 0) < 0.5 or "unreadable" in (parsed.get("reasoning") or "").lower() or parsed.get("vendor", None) is None:
